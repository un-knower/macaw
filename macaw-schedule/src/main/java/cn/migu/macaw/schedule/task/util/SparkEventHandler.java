...
public class SparkEventHandler
{
        ...
        throws Exception
    {
        ...
        Entity rltEntity = client.postCommonTaskForEntity(
            StringUtils.join("http://", ServiceName.SPARK_DRIVER_RES_MGR, "/", ServiceReqClient.SPARK_DRIVER_INIT),
    ...
    private void releaseDriverNode(TaskNodeBrief brief, String appId)
    {
        ...
        {
            //释放请求
            client.postCommonTask(
                StringUtils.join("http://", ServiceName.SPARK_DRIVER_RES_MGR, "/", ServiceReqClient.SPARK_DRIVER_FREE),
